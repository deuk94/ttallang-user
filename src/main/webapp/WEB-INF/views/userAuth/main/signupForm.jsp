...
<head>
	<title>회원가입</title>
	<link rel="stylesheet" href="${pageContext.request.contextPath}/userAuth/css/signupForm.css">
...
<script src="${pageContext.request.contextPath}/userAuth/js/signup.js"></script>
</body>
</html>
